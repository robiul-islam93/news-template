...
// page title modify start
            ...
            switch($page){
                case "single.php":
                    if(isset($_GET['id'])){
                      ...
                      $result_title = mysqli_query($connection,$sql_title) or die("Tile Query Failed");
            ...
            case "author.php":
                if(isset($_GET['aid'])){
                    ...
                    $result_title = mysqli_query($connection,$sql_title) or die("Tile Query Failed");
                    $row_title = mysqli_fetch_assoc($result_title);
                    $page_title = $row_title['first_name'] . "" . $row_title['last_name'] . " " . "News ";
                  }else{
                    $page_title = "No Post Found";
                  }
            break;
